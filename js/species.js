...
// AI-generated, to double check
const latinToEnglish = {
    [SPECIES_AULNE_GLUTINEUX]: ["Black Alder", "Common Alder", "European Alder"],
    [SPECIES_CHARME]: ["European Hornbeam", "Common Hornbeam"],
    [SPECIES_HETRE]: ["European Beech", "Common Beech"],
    [SPECIES_MARRONNIER]: ["Horse Chestnut", "Common Horse Chestnut"],
    [SPECIES_CHATAIGNIER]: ["Sweet Chestnut", "Spanish Chestnut"],
    [SPECIES_MAGNOLIA_GRANDIFLORA]: ["Southern Magnolia", "Bull Bay"],
    [SPECIES_NOISETIER]: ["Common Hazel", "Hazelnut"],
    [SPECIES_SAVONNIER]: ["Golden Rain Tree", "Pride of India"],
    [SPECIES_GINKOBILOBA]: ["Ginkgo", "Maidenhair Tree"],
    [SPECIES_EUCALYPTUS]: ["Blue Gum"],
    [SPECIES_CATALPA]: ["Common Catalpa", "Indian Bean Tree"],
    [SPECIES_LILAS_PERSE]: ["Chinaberry Tree", "Persian Lilac"],
    [SPECIES_LIQUIDAMBAR]: ["Sweet Gum", "American Sweetgum"],
    [SPECIES_TULIPIER]: ["Tulip Tree", "Yellow Poplar"],
    [SPECIES_ARBRE_DE_JUDEE]: ["Judas Tree", "Eastern Redbud"],
    [SPECIES_COTONEASTER]: ["Cotoneaster"],
    [SPECIES_ROBINIER]: ["Black Locust", "False Acacia"],
    [SPECIES_MIMOSA_HIVER]: ["Silver Wattle"],
    [SPECIES_MIMOSA_ETE]: ["Retinodes Water Wattle", "Swamp Wattle"],
    [SPECIES_MIMOSA_BLEUATRE]: ["Blue-Leaved Wattle"],
    [SPECIES_POMMIER_SAUVAGE]: ["Crab Apple", "Wild Apple"],
    [SPECIES_POMMIER]: ["Apple Tree"],
    [SPECIES_POIRIER_SAUVAGE]: ["Wild Pear"],
    [SPECIES_POIRIER]: ["Common Pear"],
    [SPECIES_POIRIER_EPINEUX]: ["Almond-Leaved Pear"],
    [SPECIES_POIRIER_CORDE]: ["Heart-leaved pear", "Plymouth Pear"],
    [SPECIES_MERISIER]: ["Wild Cherry", "Sweet Cherry"],
    [SPECIES_CERISIER_GRAPPES]: ["Bird Cherry"],
    [SPECIES_CERISIER_NOIR]: ["Black Cherry"],
    [SPECIES_CERISIER_ACIDE]: ["Sour Cherry"],
    [SPECIES_MURIER_BLANC]: ["White Mulberry"],
    [SPECIES_MURIER_NOIR]: ["Black Mulberry"],
    [SPECIES_MURIER_ARBRE]: ["*N/A*"],
    [SPECIES_MYROBOLAN]: ["Cherry Plum"],
    [SPECIES_PRUNIER]: ["Common Plum"],
    [SPECIES_PECHER]: ["Peach Tree"],
    [SPECIES_ABRICOTIER]: ["Apricot Tree"],
    [SPECIES_AMANDIER]: ["Almond Tree"],
    [SPECIES_MARMOTTIER]: ["Briançon Apricot", "Briançon Plum", "Marmot Plum"],
    [SPECIES_GRENADIER]: ["Pomegranate"],
    [SPECIES_ARBOUSIER]: ["Strawberry Tree"],
    [SPECIES_OLIVIER]: ["Olive Tree"],
    [SPECIES_FIGUIER]: ["Common Fig"],
    [SPECIES_NEFLIER]: ["Common Medlar"],
    [SPECIES_NEFLIER_DU_JAPON]: ["Loquat"],
    [SPECIES_FEVIER]: ["Honey Locust"],
    [SPECIES_CYPRES]: ["Mediterranean Cypress", "Italian Cypress"],
    [SPECIES_CYPRES_LAMBERT]: ["Monterey Cypress"],
    [SPECIES_CYPRES_ARIZONA]: ["Arizona Cypress"],
    [SPECIES_CYPRES_LAWSON]: ["Lawson's Cypress"],
    [SPECIES_CYPRES_CHAUVE]: ["Bald Cypress"],
    [SPECIES_PIN_SYLVESTRE]: ["Scots Pine"],
    [SPECIES_PIN_MARITIME]: ["Maritime Pine"],
    [SPECIES_PIN_NOIR]: ["Black Pine", "Austrian Pine"],
    [SPECIES_PIN_ALEP]: ["Aleppo Pine"],
    [SPECIES_PIN_CROCHETS]: ["Mountain Pine"],
    [SPECIES_PIN_ALPES]: ["Swiss Pine", "Arolla Pine"],
    [SPECIES_PIN_MUGO]: ["Mugo Pine", "Dwarf Mountain Pine"],
    [SPECIES_PIN_PARASOL]: ["Stone Pine", "Umbrella Pine"],
    [SPECIES_PIN_BLANC]: ["Eastern White Pine"],
    [SPECIES_EPICEA]: ["Norway Spruce"],
    [SPECIES_EPICEA_COLORADO]: ["Blue Spruce", "Colorado Spruce"],
    [SPECIES_EPICEA_SITKA]: ["Sitka Spruce"],
    [SPECIES_SAPIN]: ["Silver Fir", "European Silver Fir"],
    [SPECIES_SAPIN_VANCOUVER]: ["Grand Fir"],
    [SPECIES_SAPIN_NORDMANN]: ["Nordmann Fir"],
    [SPECIES_SAPIN_ANDALOUSIE]: ["Spanish Fir"],
    [SPECIES_MELEZE]: ["European Larch"],
    [SPECIES_MELEZE_JAPON]: ["Japanese Larch"],
    [SPECIES_CEDRE_ATLAS]: ["Atlas Cedar"],
    [SPECIES_CEDRE_HIMALAYA]: ["Deodar Cedar"],
    [SPECIES_CEDRE_LIBAN]: ["Cedar of Lebanon"],
    [SPECIES_SEQUOIA_GEANT]: ["Giant Sequoia", "Wellingtonia"],
    [SPECIES_SEQUOIA_VERT]: ["Coast Redwood"],
    [SPECIES_IF]: ["English Yew", "Common Yew"],
    [SPECIES_DOUGLAS]: ["Douglas Fir"],
    [SPECIES_THUYA]: ["Western Red Cedar"],
    [SPECIES_AUBEPINE]: ["Common Hawthorn", "Single-Seeded Hawthorn"],
    [SPECIES_AUBEPINE_EPINEUSE]: ["Midland Hawthorn"],
    [SPECIES_AUBEPINE_ESPAGNE]: ["Azerole"],
    [SPECIES_PLATANE]: ["London Plane"],
    [SPECIES_PLATANE_ORIENT]: ["Oriental Plane"],
    [SPECIES_PLATANE_OCCIDENT]: ["American Sycamore"],
    [SPECIES_MICOCOULIER]: ["European Hackberry", "European Nettle Tree"],
    [SPECIES_MICOCOULIER_OCCIDENTAL]: ["Common Hackberry"],
    [SPECIES_ERABLE_SYCOMORE]: ["Sycamore Maple"],
    [SPECIES_ERABLE_CHAMPETRE]: ["Field Maple"],
    [SPECIES_ERABLE_ARGENTE]: ["Silver Maple"],
    [SPECIES_ERABLE_NEGUNDO]: ["Box Elder", "Ash-Leaved Maple"],
    [SPECIES_ERABLE_PLANE]: ["Norway Maple"],
    [SPECIES_ERABLE_OBIER]: ["Italian maple"],
    [SPECIES_ERABLE_MONTPELLIER]: ["Montpellier Maple"],
    [SPECIES_CHENE_PEDONCULE]: ["Pedunculate Oak", "English Oak"],
    [SPECIES_CHENE_SESSILE]: ["Sessile Oak"],
    [SPECIES_CHENE_PUBESCENT]: ["Downy Oak"],
    [SPECIES_CHENE_VERT]: ["Holm Oak"],
    [SPECIES_CHENE_LIEGE]: ["Cork Oak"],
    [SPECIES_CHENE_ROUGE]: ["Northern Red Oak"],
    [SPECIES_TILLEUL_GRANDES_FEUILLES]: ["Large-Leaved Lime"],
    [SPECIES_TILLEUL_PETITES_FEUILLES]: ["Small-Leaved Lime"],
    [SPECIES_TILLEUL_COMMUN]: ["Common Lime"],
    [SPECIES_TILLEUL_ARGENTE]: ["Silver Lime"],
    [SPECIES_FRENE_COMMUN]: ["Common Ash", "European Ash"],
    [SPECIES_FRENE_FEUILLES_ETROITES]: ["Narrow-Leaved Ash"],
    [SPECIES_FRENE_FLEURS]: ["Manna Ash", "Flowering Ash"],
    [SPECIES_BOULEAU]: ["Silver Birch"],
    ...
    [SPECIES_LAURIER_ROSE]: ["Oleander"],
    [SPECIES_LAURIER_PORTUGAL]: ["Portugal Laurel"],
    [SPECIES_SAULE_BLANC]: ["White Willow"],
    [SPECIES_SAULE_MARSAULT]: ["Goat Willow"],
    [SPECIES_SAULE_FRAGILE]: ["Crack Willow"],
    [SPECIES_SAULE_TROIS_ETAMINES]: ["Almond Willow"],
    [SPECIES_SAULE_CINQ_ETAMINES]: ["Bay Willow"],
    [SPECIES_SAULE_DAPHNE]: ["European violet willow"],
    [SPECIES_SAULE_VANNIER]: ["Common Osier", "Basket Willow"],
    [SPECIES_SAULE_PLEUREUR]: ["Weeping Willow"],
    [SPECIES_ORME_CHAMPETRE]: ["Field Elm"],
    [SPECIES_ORME_MONTAGNE]: ["Wych Elm"],
    [SPECIES_ORME_LISSE]: ["European White Elm"],
    [SPECIES_ORME_HOLLANDE]: ["Dutch Elm"],
    [SPECIES_PEUPLIER_TREMBLE]: ["Aspen", "Common Aspen"],
    [SPECIES_PEUPLIER_NOIR]: ["Black Poplar"],
    [SPECIES_PEUPLIER_BLANC]: ["White Poplar"],
    [SPECIES_PEUPLIER_GRISARD]: ["Grey Poplar"],
    [SPECIES_PEUPLIER_CANADA]: ["Canadian Poplar"],
    [SPECIES_SORBIER_OISELEURS]: ["Rowan", "Mountain Ash"],
    [SPECIES_ALISIER_BLANC]: ["Common Whitebeam"],
    [SPECIES_ALISIER_TORMINAL]: ["Wild Service Tree"],
    [SPECIES_ALISIER_MOUGEOT]: ["Vosges Whitebeam", "Mougeot's Whitebeam"],
    [SPECIES_SORBIER_NAIN]: ["Dwarf Whitebeam"],
    [SPECIES_SORBIER_DOMESTIQUE]: ["Service Tree"],
    [SPECIES_ALISIER_FONTAINEBLEAU]: ["Service tree of Fontainebleau", "Broad-Leaved Whitebeam"],
    [SPECIES_NOYER]: ["Common Walnut", "English Walnut"],
    [SPECIES_NOYER_AMERIQUE]: ["Black Walnut"],
    [SPECIES_FUSAIN]: ["European Spindle"],
    [SPECIES_FUSAIN_LARGE]: ["Broad-Leaved Spindle"],
    [SPECIES_FUSAIN_CHINE]: ["Fortune's Spindle", "Winter Creeper"]
};
...
function enrichSpecies(species, csvData) {
    ...
    const enriched = species.map(speciesName => {
        ...
        var enrichedCurrent = {
            ...
            englishNames: latinToEnglish[speciesName],
        }
